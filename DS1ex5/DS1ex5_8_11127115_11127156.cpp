...
class Tree {
  ...
  public:
    ...
    vector<int> findLeftmost();  // find the most left node in tree
    vector<int> findRightmost();  // find the most right node in tree
...
void PokemonList::showAll() {
  ...
  // cout << endl << fileNO << endl;
  cout << endl;
  for ( int i = 0 ; i < HPtree.findLeftmost().size() ; i ++ ) {
    cout << "[" /*<< right << setw(3)*/ << HPtree.findLeftmost()[i] << "]\t";
    show( pSet[HPtree.findLeftmost()[i] - 1] );
  } // for

  cout << "Rightmost node:";
  // cout << endl << right << fileNO << endl;
  cout << endl;
  for ( int i = 0 ; i < HPtree.findRightmost().size() ; i ++ ) {
    cout << "[" /*<< right << setw(3)*/ << HPtree.findRightmost()[i] << "]\t";
    show( pSet[HPtree.findRightmost()[i] - 1 ] );
  } // for
...
// ============================== Tree::findLeftmost() ================================
template <typename T>
vector<int> Tree<T>::findLeftmost() {
  nodeType* temp = root;
...
// =============================== Tree::findLeftmost() ===============================
template <typename T>
vector<int> Tree<T>::findRightmost() {
  nodeType* temp = root;
